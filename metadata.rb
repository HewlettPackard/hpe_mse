...
export MSE_LABDROPS="['hpoc-uspm-nfv-common-4.3.3-2.004656.el7.noarch.rpm','hpoc-uspm-nfv-config-4.3.3-2.004656.el7.noarch.rpm','hpoc-uspm-nfv-ems-4.3.3-2.004656.el7.noarch.rpm','hpoc-nfv-base-1.1.3-3.019736.snap.1810151642.el7.x86_64.rpm','hpoc-nfv-base-selinux-1.1.3-3.019736.snap.1810151642.el7.x86_64.rpm','hpoc-nivr-nfv-3.1.2-1.019834.snap.1811131807.el7.noarch.rpm','hpoc-nivr-nfv-ocmp-3.1.2-1.019834.snap.1811131807.el7.noarch.rpm']"
...
# List of lab drops as an array of rpm packages
export MSE_LABDROPS="['hpoc-uspm-nfv-common-4.2-12.004413.RP5.el6.noarch.rpm','hpoc-uspm-nfv-config-4.2-12.004413.RP5.el6.noarch.rpm','hpoc-uspm-nfv-ems-4.2-12.004413.RP5.el6.noarch.rpm','hpoc-nivr-nfv-3.1.2-1.019834.snap.1811091015.el6.noarch.rpm','hpoc-nivr-nfv-ocmp-3.1.2-1.019834.snap.1811091015.el6.noarch.rpm','hpoc-nfv-base-1.1.3-3.019736.snap.1810021659.el6.x86_64.rpm','hpoc-nfv-base-selinux-1.1.3-3.019736.snap.1810021659.el6.x86_64.rpm']"
# URL providing common ssh keys: id_rsa, ssh_host_ecdsa_key, ssh_host_ed25519_key, ssh_host_rsa_key and their relative pub files
export MSE_SSH_KEYS_URL='ftp://mse4nfv:password@ftp.ext.hpe.com/chef/sshKeys/'
# Explicit additional packages to install if available: mlocate as a quick file searcher, omping as mulitcast checker
